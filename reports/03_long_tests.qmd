...
| AFT Suite | 19 | 19 | 0 |
| Spline Exact | 6 | 6 | 0 |
| Unpenalized Spline Suite | 18 | 18 | 0 |
| **Total** | **162** | **162** | **0** |
...
| Test | Effect | Covariates | Status |
|------|--------|------------|--------|
| sp_ph_exact_nocov | PH | None | ✅ Pass |
| sp_ph_exact_fixed | PH | Fixed | ✅ Pass |
| sp_ph_exact_tvc | PH | Time-varying | ✅ Pass |
| sp_aft_exact_nocov | AFT | None | ✅ Pass |
| sp_aft_exact_fixed | AFT | Fixed | ✅ Pass |
| sp_aft_exact_tvc | AFT | Time-varying | ✅ Pass |
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_exact_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_exact_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_exact_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_exact_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_exact_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_exact_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_exact_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_exact_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-exact-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_exact_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_exact_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_exact_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_exact_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_exact_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_exact_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_exact_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_exact_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_exact_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-exact-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_exact_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
| Test | Effect | Covariates | Status |
|------|--------|------------|--------|
| sp_ph_panel_markov_nocov | PH | None | ✅ Pass |
| sp_ph_panel_markov_fixed | PH | Fixed | ✅ Pass |
| sp_ph_panel_markov_tvc | PH | Time-varying | ✅ Pass |
| sp_aft_panel_markov_nocov | AFT | None | ✅ Pass |
| sp_aft_panel_markov_fixed | AFT | Fixed | ✅ Pass |
| sp_aft_panel_markov_tvc | AFT | Time-varying | ✅ Pass |
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_markov_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_markov_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_markov_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_markov_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_markov_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_markov_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_markov_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_markov_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-markov-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_markov_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_markov_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_markov_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_markov_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_markov_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_markov_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_markov_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_markov_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_markov_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-markov-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_markov_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
| Test | Effect | Covariates | Status |
|------|--------|------------|--------|
| sp_ph_panel_phasetype_nocov | PH | None | ✅ Pass |
| sp_ph_panel_phasetype_fixed | PH | Fixed | ✅ Pass |
| sp_ph_panel_phasetype_tvc | PH | Time-varying | ✅ Pass |
| sp_aft_panel_phasetype_nocov | AFT | None | ✅ Pass |
| sp_aft_panel_phasetype_fixed | AFT | Fixed | ✅ Pass |
| sp_aft_panel_phasetype_tvc | AFT | Time-varying | ✅ Pass |
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_phasetype_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_phasetype_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_phasetype_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_phasetype_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_phasetype_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_phasetype_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_ph_panel_phasetype_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_ph_panel_phasetype_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-ph-panel-phasetype-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_ph_panel_phasetype_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_phasetype_nocov")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-nocov-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_phasetype_nocov")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-nocov-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_phasetype_nocov")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_phasetype_fixed")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-fixed-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_phasetype_fixed")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-fixed-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_phasetype_fixed")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
...
#| echo: false
#| output: asis
result = show_test_result("sp_aft_panel_phasetype_tvc")
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-tvc-ci
#| fig-cap: "Cumulative Incidence"
result = load_longtest_result("sp_aft_panel_phasetype_tvc")
!isnothing(result) ? plot_cumulative_incidence(result) : nothing
```

```{julia}
#| echo: false
#| label: fig-sp-aft-panel-phasetype-tvc-prev
#| fig-cap: "State Prevalence"
result = load_longtest_result("sp_aft_panel_phasetype_tvc")
!isnothing(result) ? plot_state_prevalence(result) : nothing
```
