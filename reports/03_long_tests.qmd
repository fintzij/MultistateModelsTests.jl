...
Tests in `longtest_aft_suite.jl` validate accelerated failure time models.

| Test | Family | Covariates | Data Type | Status |
|------|--------|------------|-----------|--------|
| wei_aft_exact_tfc | Weibull | Fixed | Exact | ✅ Pass |
| wei_aft_panel_tfc | Weibull | Fixed | Panel | ✅ Pass |
| wei_aft_exact_tvc | Weibull | Time-varying | Exact | ✅ Pass |
| wei_aft_panel_tvc | Weibull | Time-varying | Panel | ✅ Pass |
| wei_aft_competing_exact | Weibull | Fixed | Exact (competing) | ✅ Pass |
| gom_aft_exact_tfc | Gompertz | Fixed | Exact | ✅ Pass |
