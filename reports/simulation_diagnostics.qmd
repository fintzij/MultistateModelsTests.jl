...
::: {.callout-note}
## Status: Unit & Long Tests Cover Spline Functionality

B-spline hazard validation is covered by:

1. **Unit tests** (`test_splines.jl`, 255 tests): B-spline basis evaluation, cumulative hazard vs QuadGK numerical integration, penalty matrices
2. **Long tests** (`longtest_mcem_splines.jl`, 6 scenarios): Parameter recovery for spline hazards with various functional forms
